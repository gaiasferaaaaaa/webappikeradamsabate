...
let nom, contrasenya;
let scriptURL = "https://script.google.com/macros/s/AKfycbzKQuqdqJXG2VsWy_ah1ZXWi-f33VNPuS42Ml35JRgzZqlOHmswhBHd9-Lri4OXy8gN/exec"    // s'ha de substituir la cadena de text per la URL del script
